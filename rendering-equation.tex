...
% \subsubsection{High Reflectance}
%
% We can
...
\begin{align*}
  ...
  \frac{\rho_D}{\pi}  L_{s 663} 10^\frac{-2\epsilon d C}{cos(\theta)}cos(\theta_i)sin(\theta_i)d\theta_i d\phi_i
      ...
      \right)
\end{align*}
We can solve for the concentration analytically as well.
\begin{align*}
L_{i 663} = 2\rho_D  L_{s 663}10^{-2\epsilon d C} (k - Cq)
\end{align*}

\begin{align*}
\frac{L_{i 663} 10^{2\epsilon d}}{2\rho_D  L_{s 663}} &= 10^{-C}(k - Cq)\\
ln \left( \frac{L_{i 663} 10^{2\epsilon d} }{2\rho_D  L_{s 663}} \right ) &= C\cdot ln(10^{-1})+ln(k - Cq) \\
ln \left( \frac{L_{i 663} 10^{2\epsilon d} }{2\rho_D  L_{s 663}} \right ) +k -1 &= C \\
